...
#copy config files to folder, it's a bug for aa and trunk version, not for trunk
#cp -rf ./zd_openwrt_mod/luci/applications/luci-pdnsd/root/etc ./trunk/files/
#cp -rf ./zd_openwrt_mod/luci/applications/luci-vsftpd/root/etc ./trunk/files/
#chmod 644 ./trunk/files/etc/pdnsd.conf
